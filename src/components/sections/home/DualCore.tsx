      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <motion.div
            ...
            className="relative group overflow-hidden rounded-3xl bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 border border-slate-200 dark:border-slate-700 shadow-lg flex flex-col justify-end p-6 md:p-8 min-h-[400px] h-full"
          >
            <div className="absolute top-6 right-6 md:top-8 md:right-8 p-4 bg-brand-teal/10 rounded-2xl transition-transform group-hover:scale-110 duration-300">
          ...
          <motion.div
            whileHover={{ scale: 1.02 }}
            className="relative group overflow-hidden rounded-3xl bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-brand-blue dark:to-slate-900 border border-blue-100 dark:border-slate-800 shadow-lg flex flex-col justify-end p-6 md:p-8 min-h-[400px] h-full"
          >
            <div className="absolute top-6 right-6 md:top-8 md:right-8 p-4 bg-brand-blue/10 dark:bg-white/10 rounded-2xl backdrop-blur-sm transition-transform group-hover:scale-110 duration-300">
