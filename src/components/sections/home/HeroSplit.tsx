...
export function HeroSplit() {
  return (
    <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-slate-50 dark:bg-brand-dark transition-colors duration-300">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 grid lg:grid-cols-2 gap-12 items-center py-20 md:py-0">
        ...
        >
          <div className="inline-flex items-center space-x-2 rounded-full bg-brand-teal/10 px-3 py-1 text-sm font-medium text-brand-teal dark:text-teal-400 w-max">
            ...
            <span>Next-Gen Capability Frameworks</span>
          </div>
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 max-w-xl leading-relaxed">
            CareerQue bridges the gap between potential and performance. Our premium consulting and capability development solutions are engineered for forward-thinking individuals and organizations.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            ...
            <Button size="lg" variant="outline" className="h-14 px-8 text-base bg-transparent border-slate-300 dark:border-slate-700 dark:text-white dark:hover:bg-white/5" asChild>
              <Link href="/corporate-solutions">Corporate Advisory</Link>
            </Button>
          </div>
        </motion.div>
        ...
        <motion.div 
          ...
          className="relative h-[500px] w-full rounded-2xl border border-white/20 glass dark:bg-white/5 bg-white/40 flex items-center justify-center overflow-hidden shadow-2xl"
        >
